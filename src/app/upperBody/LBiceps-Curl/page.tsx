          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-neutral-900/50 p-6 shadow-2xl backdrop-blur-md">
            ...
            <div className="mt-6 flex flex-col gap-2">
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                Do 5 repetitions for your left arm. Focus on full range of motion.
              </p>
            </div>
          </div>

          <Link href="/upperBody/RBiceps-Curl" className="w-full text-center py-3 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 transition-colors border border-white/5">
            Skip to Next Pose
          </Link>
        </div>
      </div>
