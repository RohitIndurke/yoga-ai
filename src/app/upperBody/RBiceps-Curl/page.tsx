...
=        <div className="group relative flex w-full max-w-2xl flex-col gap-4">
        ...
        <div className="flex w-full max-w-md flex-col gap-6">
          ...
          <Link href="/upperBody/R_Shoulder-press" className="w-full text-center py-3 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 transition-colors border border-white/5">
            Skip to Next Pose
          </Link>
        </div>
      </div>
